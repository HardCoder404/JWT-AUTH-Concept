      ...
      <div className="min-h-screen flex fle-col items-center justify-center p-6">
        <div className="grid lg:grid-cols-2 items-center gap-6 max-w-7xl max-lg:max-w-xl w-full">
          <form className="lg:max-w-md w-full"onSubmit={handleSubmit}>
            <h3 className="text-gray-800 text-3xl font-extrabold mb-12">Login</h3>
            ...
            <Link to={"/signup"}>
            <p className="text-sm text-gray-800 mt-6">Don't have an account? <span className="text-blue-600 font-semibold hover:underline ml-1 cursor-context-menu">Signup here</span></p>
            </Link>
          </form>
